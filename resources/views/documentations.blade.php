    ...
    "per_page": 15
                        ...
                        <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="bg-white p-3 rounded border">
                                        <code class="text-blue-600">limit</code> <span class="text-gray-500">(integer, optional)</span> - Number of results per page
                                    </div>
                                    <div class="bg-white p-3 rounded border">
                                        <code class="text-blue-600">page</code> <span class="text-gray-500">(integer, optional)</span> - Page number
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                            ...
                            <div>
                                <p class="font-medium text-gray-700 mb-2">Try it:</p>
                                <div class="bg-gray-800 p-4 rounded-lg overflow-x-auto">
                                    <code class="text-green-400 font-mono text-sm">curl -H "Authorization: Bearer YOUR_TOKEN" {{ rtrim(config('app.url'), '/') }}/api/wisatas/daerah/1?limit=5</code>
                                </div>
                            </div>
                        </div>
  ...
  "link_gmaps": "https://maps.google.com/..."
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="bg-white p-3 rounded border">
                                        <code class="text-blue-600">alamat</code> <span class="text-red-500">*</span> <span class="text-gray-500">(string, max: 500)</span> - Address
                                    </div>
                                    <div class="bg-white p-3 rounded border">
                                        <code class="text-blue-600">rating</code> <span class="text-gray-500">(float, 0-5, optional)</span> - Rating score
                                    </div>
                                    <div class="bg-white p-3 rounded border">
                                        <code class="text-blue-600">link_gmaps</code> <span class="text-gray-500">(url, optional)</span> - Google Maps link
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <p class="font-medium text-gray-700 mb-2">Try it:</p>
                                <div class="bg-gray-800 p-4 rounded-lg overflow-x-auto">
                                    <code class="text-green-400 font-mono text-sm">curl -X POST -H "Authorization: Bearer YOUR_TOKEN" -H "Content-Type: application/json" -d '{"id_daerah":1,"nama":"Wisata Baru","alamat":"Jl. Contoh No. 1","rating":4.0}' {{ rtrim(config('app.url'), '/') }}/api/wisatas</code>
                                </div>
                            </div>
                        </div>
  ...
  },
  {
    ...
    "rating": 4.5
                            ...
                            <div>
                                <p class="font-medium text-gray-700 mb-2">Try it:</p>
                                <div class="bg-gray-800 p-4 rounded-lg overflow-x-auto">
                                    <code class="text-green-400 font-mono text-sm">curl -X POST -H "Authorization: Bearer YOUR_ADMIN_TOKEN" -H "Content-Type: application/json" -d '[{"id_daerah":1,"nama":"Bulk Wisata","alamat":"Alamat Bulk"}]' {{ rtrim(config('app.url'), '/') }}/api/admin/bulk-import/wisatas</code>
                                </div>
                            </div>
                        </div>
                    </div>
