...
<head>
    ...
    <title>Wisata Jawa Timur API</title>
    @vite('resources/css/app.css')
</head>
<body class="bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
    <!-- Navigation -->
    <nav class="fixed w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg z-50">
            ...
            <div class="lg:flex lg:items-center lg:gap-12">
                ...
                <div class="lg:w-1/2 space-y-8">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white lg:text-5xl">
                        Wisata Jawa Timur API
                    </h1>
                    
                    <p class="text-lg text-gray-600 dark:text-gray-300">
                        Explore the rich cultural heritage and tourist destinations of East Java through our comprehensive API. Get detailed information about various locations, attractions, and local specialties.
                    </p>
                ...
                <div class="hidden lg:block lg:w-1/2">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('images/jatim.jpg') }}" 
                             alt="Jawa Timur" 
